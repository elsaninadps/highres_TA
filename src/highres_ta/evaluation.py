...
from .estimators import BaggingCatBoostResidualRegressor, BaggingCatBoostResidualRegressor
...
def scatter_residuals_vs_feature(residuals, feature, ax=None, **props):
    ...
    ax.scatter(feature, residuals, alpha=0.3, s=10, **props)
    ax.grid(axis="x", alpha=0.3)
    ax.axhline(0, color="black", lw=1, zorder=-1)
